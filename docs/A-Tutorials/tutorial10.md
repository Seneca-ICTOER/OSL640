...
**ATTENTION: The due date for successfully completing this tutorial (i.e. tutorial 10) is by Friday, August 16 @ 11:59 PM (Week 14).**
...
```
  ...
  3. To demonstrate the need for the **(( ))** construct, issue the following Linux commands (using the _math construct_):
...
```
  ...
  18. Use a text editor like vi or nano to create the text file called **if-1.bash** (eg. `vi if-1.bash`)
