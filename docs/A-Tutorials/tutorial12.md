...
**ATTENTION: The due date for successfully completing this tutorial (i.e. tutorial 12) is by Wednesday, December 13 @ 11:59 PM (Week 14).**
...
Here is a link to the [MS Word Document of ALL of the questions](/files/osl640_week12_practice.docx) displayed below but with extra room to answer on the document to simulate a quiz
