...
**ATTENTION: The due date for successfully completing this tutorial (i.e. tutorial 5) is by November 3 @ 11:59 PM (Week 8).**
...
Here is a link to the [MS Word Document of ALL of the questions](/files/osl640_week5_practice.docx) displayed below but with extra room to answer on the document to simulate a quiz
